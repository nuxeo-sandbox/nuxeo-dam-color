package org.nuxeo.dam.color.core.model.palette;
...
public class ColorPalette {
    ...
    static {
        ...
        list.add(new ColorGroupImpl(0, 350, 15, 80, 40, 100,"red"));
        list.add(new ColorGroupImpl(30, 15, 55, 90, 80, 100,50,42,65,"orange"));
        list.add(new ColorGroupImpl(30, 10, 40, 80, 70, 100,30,25,45,"brown"));
        ...
        list.add(new ColorGroupImpl(240, 185, 270, 80, 40, 100, "blue"));
