package org.nuxeo.dam.color.core.model.hsl;
...
public class HSLRGBConverter
{
     ...
     */
    public static long toRGB(float[] hsl)
    {
     ...
     *  @return the ARGB value of this color
     */
    public static long toRGB(float[] hsl, float alpha)
    {
     ...
     *  @return the ARGB value of this color
     */
    public static long toRGB(float h, float s, float l)
    {
     ...
     *  @return the ARGB value of this color
     */
    public static long toRGB(float h, float s, float l, float alpha)
    {
        if (s <0.0f || s > 1.0f)
        {
        ...
        long r = (long)(255*Math.max(0, HueToRGB(p, q, h + (1.0f / 3.0f))));
        long g = (long)(255*Math.max(0, HueToRGB(p, q, h)));
        long b = (long)(255*Math.max(0, HueToRGB(p, q, h - (1.0f / 3.0f))));

        long alphaInt = (long)(255*alpha);
